...
<head>
  <title>Newsletters | Rotary Local Lager</title>
...
<body>
  ...
  <?php
    echo generateHeader('newsletters');
   ?>
   ...
   <?php
      ...
      generate_sections("newsletters", session_is_admin());
    ?>
  </div>
   ...
   var filename_noprefix = "newsletters"; //db name for file!
